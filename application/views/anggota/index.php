            ...
            <table class="table table-bordered" id="dataTable">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="<?= site_url('anggota/edit/'.$a->anggota_id); ?>"
                                class="btn btn-sm btn-info">Edit</a>
                            <a href="<?= site_url('anggota/hapus/'.$a->anggota_id); ?>"
                                onclick="return confirm('Yakin mau dihapus?')" class="btn btn-sm btn-danger">Hapus</a>
                        </td>
                    </tr>
                    <?php endforeach; ?>
                </tbody>
